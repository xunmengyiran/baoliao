                ...
                <ul class="mui-table-view">
                    <li class="mui-table-view-cell mui-collapse">
                        ...
                        <div class="mui-collapse-content">
                            ...
                            <div class="mui-row">
                               <p class="mui-col-xs-6"> <input type="text" class=" guoqishij time" placeholder="请选择过期时间" /></p>
	                        ...
	                        <section class=" dfer_jh_drt">
			                    <section class="mui-col-xs-4 pr10 df_jhh_deert">
									<section class=" yj4  cen pr">
										<img src="/static/img/muban1.jpg" data-type="DE3319_FD4626" class="sd_jh_dertx_mb ab" />
									</section>
								</section>
			                </section>
		                    </div>
            ...
            <section class="cz_mb ">
		      <div class="mui-row pl10 dsf_jhh_xdf bgff">
		        <div class="mui-col-xs-6 pr10 " data-type="FE761E_EC3004">
		            <div class="pr">
		                <img src="/static/img/gouxuan.png" class="gouxuan_der" />
		                <img src="/static/img/muban1.jpg" class="w100" />
		            </div>
		        </div>
		    </div>
          </section>
