...
import com.baoliao.weixin.wechatpay.WXPayConstants.SignType;
...
public class WXPay {
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        ...
        System.out.println("开始生成的签名" + reqData.get("sign"));
        System.out.println("开始生成的签名的参数:" + reqData);
        return reqData;
    }
    ...
    public Map<String, String> processResponseXmlTX(String xmlStr) throws Exception {
        String RETURN_CODE = "return_code";
        String return_code;
        Map<String, String> respData = WXPayUtil.xmlToMap(xmlStr);
        if (respData.containsKey(RETURN_CODE)) {
     ...
     * @throws Exception
     */
    public Map<String, String> tixian(Map<String, String> reqData) throws Exception {
        return this.tixian(reqData, this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
//        return this.refund(reqData, this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
    }

    public Map<String, String> tixian(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WXPayConstants.MMPAYMKTTRANSFERS_URL_SUFFIX;
        } else {
            url = WXPayConstants.MMPAYMKTTRANSFERS_URL_SUFFIX;
        }
        String respXml = this.requestWithCert(url, reqData, connectTimeoutMs, readTimeoutMs);
        return this.processResponseXmlTX(respXml);
    }
