...
function() {
    return function(e) {
        ...
        function r(e, t) {
            var n = this;
            if (!e) throw new Error("娌℃湁鏀跺埌鍥剧墖锛屽彲鑳界殑瑙ｅ喅鏂规锛歨ttps://github.com/think2011/localResizeIMG/issues/7");
            t = t || {},
            n.defaults = {
                width: null,
                height: null,
        ...
        r.prototype.init = function() {
            ...
            if (e.img = i, e.blob = l, e.canvas = u, n ? e.fileName = r ? "base64.jpg": t.split("/").pop() : e.fileName = t.name, !document.createElement("canvas").getContext) throw new Error("娴忚鍣ㄤ笉鏀寔canvas");
            return new a(function(n, a) {
                i.onerror = function() {
                    var e = new Error("鍔犺浇鍥剧墖鏂囦欢澶辫触");
                    throw a(e),
                    e
                },
                i.onload = function() {
        ...
        var r, i; (function() {
            ...
            function d(e, t, n, r, i) {
                ...
                case 4:
                    ...
                    return a;
                case 5:
                    if (1 == d) return l = e.getUint32(g, !i),
                    c = e.getUint32(g + 4, !i),
                    s = new Number(l / c),
                    s.numerator = l,
                    s.denominator = c,
                    s;
                    for (a = [], u = 0; d > u; u++) l = e.getUint32(g + 8 * u, !i),
