...
function(a, b) {
    function c(c) {
        this.os = this.os || {},
        c.match(/Html5Plus/i) && (this.os.plus = !0, a(function() {
    ...
    j = function(b, d, e, f) {
        return function(e) {
            ...
            function(b, c) {
                ...
                function(b, c) {
                    a.each(c,
                    function(a, b) { ! 1 === b.call(i, e) && (e.preventDefault(), e.stopPropagation())
                    },
                    !0)
                },
                !0),
                !e.isPropagationStopped() && void 0
            },
            !0)
        }
    },
...
function(a, b, c) {
    ...
    function(b) {
        ...
        function(a, c) {
            return c.name,
            c.hasOwnProperty("handle") && c.handle(b, d) ? (e = !0, b.preventDefault(), !1) : void 0
        }), !e)); d = d.parentNode);
    })
} (mui, window, document),
function(a) {
...
function(a, b) {
    ...
    u = function(b) {
        ...
        if (b.gesture.type != a.EVENT_CANCEL && (k > 25 || void 0 === i.velocity)) {
    ...
    x = function(b, c) {
        var d = w(a.slice.call(b.touches || [b])),
        e = b.type,
        f = [],
        g = [];
        if (e !== a.EVENT_START && e !== a.EVENT_MOVE || 1 !== d.length) {
            ...
            f = [],
            g = [],
            i = w(a.slice.call(b.changedTouches || [b]));
            c.target = b.target;
            var j = a.gestures.session.target || b.target;
            if (f = d.filter(function(a) {
                return n(a.target, j)
            }), e === a.EVENT_START) for (h = 0; h < f.length;) v[f[h].identifier] = !0,
            h++;
            for (h = 0; h < i.length;) v[i[h].identifier] && g.push(i[h]),
            (e === a.EVENT_END || e === a.EVENT_CANCEL) && delete v[i[h].identifier],
            h++;
            if (!g.length) return ! 1
        } else v[d[0].identifier] = !0,
        f = d,
        g = d,
        c.target = b.target;
    ...
    y = function(b) {
        ...
        x(b, c) && (t(c), m(b, c), a.gestures.session.prevTouch = c, b.type !== a.EVENT_END || a.isTouchable || (a.gestures.touch = a.gestures.session = {}))
    };
...
function(a, b) {
    var c, d, e = function(b, e) {
        ...
        case a.EVENT_END:
            if (!e.isFinal) return;
            var h = f.target;
            if (!h || h.disabled || h.classList && h.classList.contains("mui-disabled")) return;
            if (e.distance < g.tapMaxDistance && e.deltaTime < g.tapMaxTime) {
                if (a.options.gestureConfig.doubletap && c && c === h && d && e.timestamp - d < g.tapMaxInterval) return a.trigger(h, "doubletap", e),
                d = a.now(),
                void(c = h);
                a.trigger(h, "tap", e),
                d = a.now(),
    ...
    var c = function(c, d) {
        ...
        case a.EVENT_MOVE:
            if (a.options.gestureConfig.pinch) {
                ...
                g > i ? (i = g - 1e-12, a.trigger(f.target, b + "out", d)) : i > g && (i = g + 1e-12, a.trigger(f.target, b + "in", d)),
...
function(a) {
    ...
    a.init = function(b) {
        ...
        a.ready(function() {
            a.doAction("inits",
            function(b, d) { ! (c[d.name] && !d.repeat) && (d.handle.call(a), c[d.name] = !0)
            })
        }),
        this
    },
...
function(a) {
    ...
    a.createWindow = function(b, c) {
        if (window.plus) {
            ...
            } else ! 1 !== c && (d = plus.webview.create(b.url, e, a.windowOptions(b.styles), b.extras), b.subpages && a.each(b.subpages,
            function(b, c) {
                var e = c.id || c.url,
...
function(a, b) {
    ...
    a.back = function() { ("function" != typeof a.options.beforeback || !1 !== a.options.beforeback()) && a.doAction("backs")
    },
    ...
    function(b) {
        var c = b.detail; ! 0 === a.options.swipeBack && Math.abs(c.angle) < 3 && a.back()
    })
} (mui, window),
function(a, b) {
...
function(a, b, c) {
    ...
    var j = function(a, b) {
        var c = b.context;
        return ! 1 !== b.beforeSend.call(c, a, b) && void 0
    },
    k = function(a, b, c) {
    ...
    a.ajax = function(d, e) {
        ...
        o(f);
        var h = f.dataType; ! 1 !== f.cache && (e && !0 === e.cache || "script" !== h) || (f.url = p(f.url, "_=" + a.now()));
        ...
        if (s("X-Requested-With", "XMLHttpRequest"), s("Accept", n || "*/*"), (n = f.mimeType || n) && (n.indexOf(",") > -1 && (n = n.split(",", 2)[0]), u.overrideMimeType && u.overrideMimeType(n)), (f.contentType || !1 !== f.contentType && f.data && "GET" !== f.type.toUpperCase()) && s("Content-Type", f.contentType || "application/x-www-form-urlencoded"), f.headers) for (var w in f.headers) s(w, f.headers[w]);
        if (u.setRequestHeader = s, u.onreadystatechange = function() {
            if (4 === u.readyState) {
                ...
                if (u.status >= 200 && u.status < 300 || 304 === u.status || 0 === u.status && d && u.responseText) {
                    ...
                    b = u.responseText;
                    try {
                        "script" === h ? (0, eval)(b) : "xml" === h ? b = u.responseXML: "json" === h && (b = i.test(b) ? null: a.parseJSON(b))
                    } catch(a) {
                        c = a
                    }
                    c ? l(c, "parsererror", u, f) : k(b, u, f)
                } else {
                    var e = u.status ? "error": "abort",
                    g = u.statusText || null;
                    d && (e = "error", g = "404"),
                    l(g, e, u, f)
                }
...
function(a, b, c) {
    a.offset = function(a) {
        ...
        return void 0 !== typeof a.getBoundingClientRect && (c = a.getBoundingClientRect()),
        {
            top: c.top + b.pageYOffset - a.clientTop,
            left: c.left + b.pageXOffset - a.clientLeft
        }
    }
} (mui, window),
function(a, b) {
...
function(a, b, c) {
    ...
    l = f + " " + h + " " + i,
    m = f + " " + h + " mui-spinner",
    n = ['<div class="mui-pull">', '<div class="{icon}"></div>', '<div class="' + g + '">{contentrefresh}</div>', "</div>"].join(""),
    o = {
        init: function(b, c) {
        ...
        _initPulldownRefresh: function() {
            ...
            this.pullPocket.classList.add(j),
        ...
        _initPocket: function() {
            var a = this.options;
            a.down && a.down.hasOwnProperty("callback") && (this.topPocket = this.scroller.querySelector("." + d), this.topPocket || (this.topPocket = this._createPocket(d, a.down, l), this.wrapper.insertBefore(this.topPocket, this.wrapper.firstChild)), this.topLoading = this.topPocket.querySelector("." + f), this.topCaption = this.topPocket.querySelector("." + g)),
            a.up && a.up.hasOwnProperty("callback") && (this.bottomPocket = this.scroller.querySelector("." + e), this.bottomPocket || (this.bottomPocket = this._createPocket(e, a.up, m), this.scroller.appendChild(this.bottomPocket)), this.bottomLoading = this.bottomPocket.querySelector("." + f), this.bottomCaption = this.bottomPocket.querySelector("." + g), this.wrapper.addEventListener("scrollbottom", this))
        },
        _createPocket: function(a, c, d) {
            var e = b.createElement("div");
            return e.className = a,
            e.innerHTML = n.replace("{contentrefresh}", c.contentinit).replace("{icon}", d),
            e
        },
        _resetPullDownLoading: function() {
            var a = this.pullLoading;
            a && (this.pullCaption.innerHTML = this.options.down.contentdown, a.style.webkitTransition = "", a.style.webkitTransform = "", a.style.webkitAnimation = "", a.className = l)
        },
        _setCaptionClass: function(a, b, c) {
            if (!a) switch (c) {
            case this.options.up.contentdown:
                b.className = g + " mui-pull-caption-down";
                break;
            case this.options.up.contentrefresh:
                b.className = g + " mui-pull-caption-refresh";
                break;
            case this.options.up.contentnomore:
                b.className = g + " mui-pull-caption-nomore"
            }
        },
        _setCaption: function(a, b) {
            if (!this.loading) {
                ...
                d && (b ? setTimeout(function() {
                    ...
                    g ? f.className = l: (h._setCaptionClass(!1, e, a), f.className = m),
                    f.style.webkitAnimation = "",
                    f.style.webkitTransition = "",
                    f.style.webkitTransform = ""
                },
                100) : a !== this.lastTitle && (e.innerHTML = a, g ? a === c.down.contentrefresh ? (f.className = m, f.style.webkitAnimation = "spinner-spin 1s step-end infinite") : a === c.down.contentover ? (f.className = "mui-pull-loading mui-icon mui-icon-pulldown", f.style.webkitTransition = "-webkit-transform 0.3s ease-in", f.style.webkitTransform = "rotate(180deg)") : a === c.down.contentdown && (f.className = l, f.style.webkitTransition = "-webkit-transform 0.3s ease-in", f.style.webkitTransform = "rotate(0deg)") : (a === c.up.contentrefresh ? f.className = m + " " + k: f.className = m + " mui-hidden", h._setCaptionClass(!1, e, a)), this.lastTitle = a))
            }
        }
    };
    a.PullRefresh = o
    ...
    j = a.Class.extend({
        init: function(b, c) {
            ...
            this.options = a.extend(!0, {
                ...
                bounce: !0,
                bounceTime: 500,
                bounceEasing: i.outCirc,
                scrollTime: 500,
                scrollEasing: i.outCubic,
        ...
        _initSnap: function() {
            ...
            j = 0; b > j; j++) {
                ...
                e = this._getSnapX(l),
                i = Math.round(m * this.options.snapX),
                f = e - i,
                g = e - m + i,
                this.pages[c][d] = {
                    x: e,
                ...
                k.classList.contains(h) && (this.currentPage = this.pages[c][0]),
                e >= this.maxScrollX && c++
            }
        ...
        _gotoPage: function(a) {
            ...
            for (var b = 0,
            c = this.snaps.length; c > b; b++) b === a ? this.snaps[b].classList.add(h) : this.snaps[b].classList.remove(h);
        ...
        _drag: function(c) {
            ...
            var f = isReturn = !1;
            if (this._getDirectionByAngle(d.angle), "left" === d.direction || "right" === d.direction ? this.options.scrollX ? (f = !0, this.moved || (a.gestures.session.lockDirection = !0, a.gestures.session.startDirection = d.direction)) : this.options.scrollY && !this.moved && (isReturn = !0) : "up" === d.direction || "down" === d.direction ? this.options.scrollY ? (f = !0, this.moved || (a.gestures.session.lockDirection = !0, a.gestures.session.startDirection = d.direction)) : this.options.scrollX && !this.moved && (isReturn = !0) : isReturn = !0, (this.moved || f) && (c.stopPropagation(), d.gesture && d.gesture.preventDefault()), !isReturn) {
            ...
            if (this.moved) {
                ...
                if (this._clearRequestAnimationFrame(), "dragend" !== b.type || !c.flick) {
                    ...
                    if (this.isInTransition = !1, !this.resetPosition(this.options.bounceTime)) {
                        ...
                        d != this.x || e != this.y ? ((d > 0 || d < this.maxScrollX || e > 0 || e < this.maxScrollY) && (g = i.quadratic), void this.scrollTo(d, e, f, g)) : void a.trigger(this.scroller, "scrollend", this)
                    }
                }
            }
        },
        ...
        _createScrollBar: function(a) {
            ...
            d.className = "mui-scrollbar-indicator",
            b.appendChild(d),
            a === f ? (this.scrollbarY = b, this.scrollbarIndicatorY = d) : a === g && (this.scrollbarX = b, this.scrollbarIndicatorX = d),
        ...
        _momentum: function(a, b, c, d, e, f) {
            var g, h, i = parseFloat(Math.abs(b) / c);
            return f = void 0 === f ? 6e-4: f,
            g = a + i * i / (2 * f) * (0 > b ? -1 : 1),
            h = i / f,
            d > g ? (g = e ? d - e / 2.5 * (i / 8) : d, b = Math.abs(g - a), h = b / i) : g > 0 && (g = e ? e / 2.5 * (i / 8) : 0, b = Math.abs(a) + g, h = b / i),
            {
        ...
        resetPosition: function(a) {
            ...
            (b != this.x || c != this.y) && (this.scrollTo(b, c, a, this.options.scrollEasing), !0)
        },
        _reInit: function() {
            for (var a = this.wrapper.querySelectorAll(".mui-scroll"), b = 0, c = a.length; c > b; b++) if (a[b].parentNode === this.wrapper) {
                this.scroller = a[b];
                break
            }
            this.scrollerStyle = this.scroller && this.scroller.style
...
function(a, b, c, d) {
    ...
    g = a.Scroll.extend(a.extend({
        ...
        resetPosition: function(a) {
            if (this.pulldown) {
                if (this.y >= this.options.down.height) return this.pulldownLoading(void 0, a || 0),
...
function(a, b) {
    var c = "mui-slider",
    d = "mui-action-previous",
    e = "mui-active",
    f = ".mui-slider-item",
    g = a.Slider = a.Scroll.extend({
        init: function(b, c) {
            this._super(b, a.extend(!0, {
                fingers: 1,
                interval: 0,
        ...
        _init: function() {
            this._reInit(),
            this.scroller && (this.scrollerStyle = this.scroller.style, this.progressBar = this.wrapper.querySelector(".mui-slider-progress-bar"), this.progressBar && (this.progressBarWidth = this.progressBar.offsetWidth, this.progressBarStyle = this.progressBar.style), this._super(), this._initTimer())
        },
        ...
        _handleSlide: function(b) {
            ...
            if (b.target === c.wrapper) {
                ...
                for (var g = c.scroller.querySelectorAll(f), h = [], i = 0, j = g.length; j > i; i++) {
                    var k = g[i];
                    k.parentNode === c.scroller && h.push(k)
                }
                var l = d.slideNumber;
                if (c.loop && (l += 1), !c.wrapper.classList.contains("mui-segmented-control")) for (var i = 0,
                j = h.length; j > i; i++) {
                    var k = h[i];
                    k.parentNode === c.scroller && (i === l ? k.classList.add(e) : k.classList.remove(e))
                }
                ...
                if (m) {
                    ...
                    if (n.length > 0) for (var i = 0,
                    j = n.length; j > i; i++) n[i].classList[i === d.slideNumber ? "add": "remove"](e);
                    else {
                        var o = m.querySelector(".mui-number span");
                        if (o) o.innerText = d.slideNumber + 1;
                        else for (var p = m.querySelectorAll(".mui-control-item"), i = 0, j = p.length; j > i; i++) p[i].classList[i === d.slideNumber ? "add": "remove"](e)
                    }
                }
                b.stopPropagation()
            }
        ...
        _reInit: function() {
            for (var a = this.wrapper.querySelectorAll(".mui-slider-group"), b = 0, c = a.length; c > b; b++) if (a[b].parentNode === this.wrapper) {
                this.scroller = a[b];
                break
            }
            this.scrollerStyle = this.scroller && this.scroller.style,
    ...
    a.fn.slider = function(b) {
        ...
        return this.each(function() {
            var e = this;
            if (this.classList.contains(c) || (e = this.querySelector("." + c)), e && e.querySelector(f)) {
                var h = e.getAttribute("data-slider");
                h ? (d = a.data[h]) && b && d.refresh(b) : (h = ++a.uuid, a.data[h] = d = new g(e, b), e.setAttribute("data-slider", h))
            }
        }),
        d
    },
        ...
        if (!1 !== window.__NWin_Enable__) {
            ...
            h = a.Class.extend({
                ...
                _pulldownLoading: function() {
                    var b = this;
                    a.plusReady(function() {
                        plus.webview.getWebviewById(b.options.webviewId).setBounce({
                            offset: {
                ...
                pullupLoading: function(a) {
                    ...
                    b.isLoading || (b.isLoading = !0, !1 !== b.pulldown ? b._initPullupRefresh() : this.pullPocket.classList.add(e), setTimeout(function() {
                        ...
                        b.pullCaption.className = f + " mui-pull-caption-refresh",
                ...
                endPullupToRefresh: function(a) {
                    var e = this;
                    e.pullLoading && (e.pullLoading.classList.remove(c), e.pullLoading.classList.add(d), e.isLoading = !1, a ? (e.finished = !0, e.pullCaption.className = f + " mui-pull-caption-nomore", e.pullCaption.innerHTML = e.options.up.contentnomore, b.removeEventListener("plusscrollbottom", e), window.removeEventListener("dragup", e)) : (e.pullCaption.className = f + " " + g, e.pullCaption.innerHTML = e.options.up.contentdown))
                },
                disablePullupToRefresh: function() {
                    this._initPullupRefresh(),
            ...
            a.fn.pullRefresh = function(c) {
                ...
                i = d.getAttribute("data-pullrefresh-plus-" + g);
                return ! (!i && void 0 === e) && (i ? f = a.data[i] : (i = ++a.uuid, d.setAttribute("data-pullrefresh-plus-" + g, i), b.body.classList.add("mui-plus-pullrefresh"), a.data[i] = f = new h(d, c)), c.down && c.down.auto ? f._pulldownLoading() : c.up && c.up.auto && f.pullupLoading(), f)
            }
        }
    })
} (mui, document),
function(a, b, c, d) {
    ...
    k = a.Class.extend({
        init: function(b, d) {
            this.wrapper = this.element = b,
            this.scroller = this.wrapper.querySelector(j),
        ...
        handleEvent: function(b) {
            ...
            case "dragend":
                if (this.isDragging) {
                    ...
                    d = c.direction;
                    this.isDragging = !1,
                    this.offCanvas.classList.add(i),
                    this.scroller.classList.add(i);
                    var e = 0,
                    ...
                    if (this.slideIn) {
                        ...
                        if (0 === (e = f >= 0 ? this.offCanvasLeftWidth && f / this.offCanvasLeftWidth || 0 : this.offCanvasRightWidth && f / this.offCanvasRightWidth || 0)) return this.openPercentage(0),
        ...
        _dispatchEvent: function() {
            this.classList.contains(h) ? a.trigger(this.wrapper, "shown", this) : a.trigger(this.wrapper, "hidden", this)
        },
        ...
        isShown: function(a) {
            var b = !1;
            if (this.slideIn) b = "left" === a ? this.classList.contains(h) && this.wrapper.querySelector("." + e + "." + h) : "right" === a ? this.classList.contains(h) && this.wrapper.querySelector("." + f + "." + h) : this.classList.contains(h) && (this.wrapper.querySelector("." + e + "." + h) || this.wrapper.querySelector("." + f + "." + h));
            else {
                var c = this.getTranslateX();
                b = "right" === a ? this.classList.contains(h) && 0 > c: "left" === a ? this.classList.contains(h) && c > 0 : this.classList.contains(h) && 0 !== c
            }
            return b
        },
        close: function() {
            this._initOffCanvasVisible(),
            this.offCanvas = this.wrapper.querySelector("." + f + "." + h) || this.wrapper.querySelector("." + e + "." + h),
            this.offCanvasWidth = this.offCanvas.offsetWidth,
            this.scroller && (this.offCanvas.offsetHeight, this.offCanvas.classList.add(i), this.scroller.classList.add(i), this.openPercentage(0))
        },
        show: function(a) {
            return this._initOffCanvasVisible(),
            !this.isShown(a) && (a || (a = this.wrapper.querySelector("." + f) ? "right": "left"), "right" === a ? (this.offCanvas = this.offCanvasRight, this.offCanvasWidth = this.offCanvasRightWidth) : (this.offCanvas = this.offCanvasLeft, this.offCanvasWidth = this.offCanvasLeftWidth), this.scroller && (this.offCanvas.offsetHeight, this.offCanvas.classList.add(i), this.scroller.classList.add(i), this.openPercentage("left" === a ? 100 : -100)), !0)
        },
        toggle: function(a) {
            var b = a;
    ...
    l = function(a) {
        if (parentNode = a.parentNode, parentNode) {
            if (parentNode.classList.contains(g)) return parentNode;
            if (parentNode = parentNode.parentNode, parentNode.classList.contains(g)) return parentNode
        }
    },
    m = function(b, d) {
    ...
    a.fn.offCanvas = function(b) {
        ...
        return this.each(function() {
            var d = null,
            e = this;
            e.classList.contains(g) || (e = l(e));
            var f = e.getAttribute("data-offCanvas");
            f ? d = a.data[f] : (f = ++a.uuid, a.data[f] = d = new k(e, b), e.setAttribute("data-offCanvas", f)),
...
function(a, b) {
    var c = function(a, b) {
        ...
        !(!c || !~c.indexOf("mui-action")) && (b.classList.contains("mui-action-back") && a.preventDefault(), b)
    };
    a.registerTarget({
        name: "action",
        index: 50,
...
function(a, b, c, d) {
    var e = function(a, b) {
        if ("A" === b.tagName && b.hash) {
            ...
            if (d && d.classList.contains("mui-modal")) return d
        }
        return ! 1
    };
    a.registerTarget({
...
function(a, b, c, d) {
    var e = "mui-popover-arrow",
    f = "mui-popover-action",
    g = "mui-backdrop",
    h = "mui-bar-backdrop",
    i = "mui-backdrop-action",
    j = "mui-active",
    k = "mui-bottom",
    l = function(b, d) {
        if ("A" === d.tagName && d.hash) {
            if (a.targets._popover = c.getElementById(d.hash.replace("#", "")), a.targets._popover && a.targets._popover.classList.contains("mui-popover")) return d;
    ...
    o = function(b) {
        s(this, "none"),
        this.removeEventListener("webkitTransitionEnd", o),
        this.removeEventListener(a.EVENT_MOVE, a.preventDefault),
        a.trigger(this, "hidden", this)
    },
    p = function() {
        var b = c.createElement("div");
        return b.classList.add(g),
        b.addEventListener(a.EVENT_MOVE, a.preventDefault),
        b.addEventListener("tap",
        function(b) {
            var d = a.targets._popover;
            d && (d.addEventListener("webkitTransitionEnd", o), d.classList.remove(j), q(d), c.body.setAttribute("style", ""))
        }),
        b
    } (),
    q = function(b) {
        ...
        m = a.later(function() { ! b.classList.contains(j) && p.parentNode && p.parentNode === c.body && c.body.removeChild(p)
        },
        350)
    };
    b.addEventListener("tap",
    function(b) {
        if (a.targets.popover) {
            ...
            d && (b.detail.gesture.preventDefault(), r(a.targets._popover, a.targets.popover))
        }
    });
    var r = function(a, b, d) {
        if (! ("show" === d && a.classList.contains(j) || "hide" === d && !a.classList.contains(j))) {
            m && m.cancel(),
            a.removeEventListener("webkitTransitionEnd", n),
            a.removeEventListener("webkitTransitionEnd", o),
            p.classList.remove(h),
            p.classList.remove(i);
            var e = c.querySelector(".mui-popover.mui-active");
            if (e && (e.addEventListener("webkitTransitionEnd", o), e.classList.remove(j), a === e)) return void q(e);
            var g = !1; (a.classList.contains("mui-bar-popover") || a.classList.contains(f)) && (a.classList.contains(f) ? (g = !0, p.classList.add(i)) : p.classList.add(h)),
            s(a, "block"),
            a.offsetHeight,
            a.classList.add(j),
    ...
    t = function(d, g, h) {
        if (d && g) {
            ...
            p = a.offset(g),
            q = d.querySelector("." + e);
            q || (q = c.createElement("div"), q.className = e, d.appendChild(q));
            var r = q && q.offsetWidth / 2 || 0,
            t = 0,
            u = 0,
            v = 0,
            w = 0,
            x = d.classList.contains(f) ? 0 : 5,
            y = "top";
            m + r < p.top - b.pageYOffset ? t = p.top - m - r: m + r < j - (p.top - b.pageYOffset) - o ? (y = "bottom", t = p.top + o + r) : (y = "middle", t = Math.max((j - m) / 2 + b.pageYOffset, 0), u = Math.max((i - l) / 2 + b.pageXOffset, 0)),
            "top" === y || "bottom" === y ? (u = n / 2 + p.left - l / 2, v = u, x > u && (u = x), u + l > i && (u = i - l - x), q && ("top" === y ? q.classList.add(k) : q.classList.remove(k), v -= u, w = l / 2 - r / 2 + v, w = Math.max(Math.min(w, l - 2 * r - 6), 6), q.setAttribute("style", "left:" + w + "px"))) : "middle" === y && q.setAttribute("style", "display:none"),
            s(d, "block", t, u)
        }
    };
    ...
    a.fn.popover = function() {
        ...
        this.each(function() {
            ...
            ("show" === b[0] || "hide" === b[0] || "toggle" === b[0]) && r(this, b[1], b[0])
        })
    }
} (mui, window, document),
function(a, b, c, d, e) {
    ...
    h = "mui-tab-item",
    i = function(a, b) {
        return ! (!b.classList || !b.classList.contains(f) && !b.classList.contains(h)) && (b.parentNode && b.parentNode.classList && b.parentNode.classList.contains("mui-segmented-control-vertical") || a.preventDefault(), b)
    };
    a.registerTarget({
        name: "tab",
        index: 80,
    ...
    function(b) {
        var d = a.targets.tab;
        if (d) {
            for (var e, i, j, k = "mui-active",
            l = "." + k,
            m = d.parentNode; m && m !== c; m = m.parentNode) {
                if (m.classList.contains("mui-segmented-control")) {
                    e = m.querySelector(l + "." + f);
                    break
                }
                m.classList.contains("mui-bar-tab") && (e = m.querySelector(l + "." + h))
            }
            e && e.classList.remove(k);
            var n = d === e;
            if (d && d.classList.add(k), d.hash && (j = c.getElementById(d.hash.replace("#", "")))) {
                if (!j.classList.contains(g)) return void d.classList[n ? "remove": "add"](k);
                if (!n) {
                    var o = j.parentNode;
                    i = o.querySelectorAll("." + g + l);
                    for (var p = 0; p < i.length; p++) {
                        var q = i[p];
                        q.parentNode === o && q.classList.remove(k)
                    }
                    j.classList.add(k);
                    for (var r = [], s = o.querySelectorAll("." + g), p = 0; p < s.length; p++) s[p].parentNode === o && r.push(s[p]);
                    a.trigger(j, a.eventName("shown", "tab"), {
                        tabNumber: Array.prototype.indexOf.call(r, j)
                    }),
...
function(a, b, c) {
    ...
    h.prototype.handleEvent = function(b) {
        if (!this.classList.contains("mui-disabled")) switch (b.type) {
        case a.EVENT_START:
            this.start(b);
            break;
        case "drag":
    ...
    h.prototype.drag = function(a) {
        var b = a.detail;
        this.isDragging || ("left" === b.direction || "right" === b.direction) && (this.isDragging = !0, this.lastChanged = void 0, this.initialState = this.classList.contains(e)),
        this.isDragging && (this.setTranslateX(b.deltaX), a.stopPropagation(), b.gesture.preventDefault())
    },
    h.prototype.swiperight = function(a) {
        this.isDragging && a.stopPropagation()
    },
    h.prototype.end = function(b) {
        this.classList.remove(f),
        this.isDragging ? (this.isDragging = !1, b.stopPropagation(), a.trigger(this.element, "toggle", {
            isActive: this.classList.contains(e)
        })) : this.toggle()
    },
    h.prototype.toggle = function(b) {
        ...
        c.contains(e) ? (c.remove(e), this.handle.style.webkitTransform = "translate(0,0)") : (c.add(e), this.handle.style.webkitTransform = "translate(" + this.handleX + "px,0)"),
        a.trigger(this.element, "toggle", {
            isActive: this.classList.contains(e)
        })
    },
    h.prototype.setTranslateX = a.animationFrame(function(a) {
        if (this.isDragging) {
            var b = !1; (this.initialState && -a > this.handleX / 2 || !this.initialState && a > this.handleX / 2) && (b = !0),
            this.lastChanged !== b && (b ? (this.handle.style.webkitTransform = "translate(" + (this.initialState ? 0 : this.handleX) + "px,0)", this.classList[this.initialState ? "remove": "add"](e)) : (this.handle.style.webkitTransform = "translate(" + (this.initialState ? this.handleX: 0) + "px,0)", this.classList[this.initialState ? "add": "remove"](e)), this.lastChanged = b)
        }
    }),
    a.fn.
    switch = function(b) {
        ...
        return this.each(function() {
            ...
            d ? b = a.data[d] : (d = ++a.uuid, a.data[d] = new h(this), this.setAttribute("data-switch", d)),
            c.push(b)
        }),
        c.length > 1 ? c: c[0]
    },
...
function(a, b, c) {
    ...
    o = "." + h,
    p = "." + j,
    q = isOpened = openedActions = progress = !1,
    r = sliderActionLeft = sliderActionRight = buttonsLeft = buttonsRight = sliderDirection = sliderRequestAnimationFrame = !1,
    s = translateX = lastTranslateX = sliderActionLeftWidth = sliderActionRightWidth = 0,
    t = function(a) {
        a ? f ? f.classList.add(g) : e && e.classList.add(g) : (s && s.cancel(), f ? f.classList.remove(g) : e && e.classList.remove(g))
    },
    u = function() {
        if (translateX !== lastTranslateX) {
            if (buttonsRight && buttonsRight.length > 0) {
                ...
                b = buttonsRight.length; b > a; a++) {
                    ...
                    v(c, translateX - buttonOffset * (1 + Math.max(progress, -1)))
                }
            }
            if (buttonsLeft && buttonsLeft.length > 0) {
                ...
                b = buttonsLeft.length; b > a; a++) {
                    ...
                    v(d, translateX + buttonOffset * (1 - Math.min(progress, 1)))
                }
            }
            v(r, translateX),
    ...
    function(b) {
        e && t(!1),
        e = f = !1,
        q = isOpened = openedActions = !1;
        for (var g = b.target,
        h = !1; g && g !== c; g = g.parentNode) if (g.classList) {
            var k = g.classList;
            if (("INPUT" === g.tagName && "radio" !== g.type && "checkbox" !== g.type || "BUTTON" === g.tagName || k.contains("mui-switch") || k.contains(j) || k.contains("mui-disabled")) && (h = !0), k.contains("mui-collapse-content")) break;
            if (k.contains("mui-table-view-cell")) {
                e = g;
                var m = e.parentNode.querySelector(o);
                if (!e.parentNode.classList.contains(i) && m && m !== e) return a.swipeoutClose(m),
                void(e = h = !1);
                if (!e.parentNode.classList.contains("mui-grid-view")) {
                    var n = e.querySelector("a");
                    n && n.parentNode === e && (f = n)
                }
                var p = e.querySelector(l);
                p && (d(e), b.stopPropagation()),
                h || (p ? (s && s.cancel(), s = a.later(function() {
                    t(!0)
                },
                100)) : t(!0));
                break
    ...
    var w = {
        ...
        dragend: function(b) {
            if (q) {
                ...
                q = !1;
                var d = "close",
                f = "toLeft" === sliderDirection ? sliderActionRightWidth: sliderActionLeftWidth; (c.swipe || Math.abs(translateX) > f / 2) && (isOpened ? "left" === c.direction && "right" === openedActions ? d = "open": "right" === c.direction && "left" === openedActions && (d = "open") : d = "open"),
                e.classList.add(k);
                var g;
                if ("open" === d) {
                    var i = "toLeft" === sliderDirection ? -f: f;
                    if (v(r, i), void 0 !== (g = "toLeft" === sliderDirection ? buttonsRight: buttonsLeft)) {
                        for (var j = null,
                        l = 0; l < g.length; l++) j = g[l],
                        v(j, i);
                ...
                var m;
                if (buttonsLeft && buttonsLeft.length > 0 && buttonsLeft !== g) for (var l = 0,
                n = buttonsLeft.length; n > l; l++) {
                    var o = buttonsLeft[l];
                    m = o._buttonOffset,
                    void 0 === m && (o._buttonOffset = sliderActionLeftWidth - o.offsetLeft - o.offsetWidth),
                    v(o, m)
                }
                if (buttonsRight && buttonsRight.length > 0 && buttonsRight !== g) for (var l = 0,
                n = buttonsRight.length; n > l; l++) {
                    var p = buttonsRight[l];
                    m = p._buttonOffset,
                    void 0 === m && (p._buttonOffset = p.offsetLeft),
                    v(p, -m)
                }
            }
        }
    ...
    a.swipeoutOpen = function(b, c) {
        if (b) {
            var d = b.classList;
            if (!d.contains(h)) {
                c || (c = b.querySelector(n) ? "right": "left");
                var e = b.querySelector(a.classSelector(".slider-" + c));
                if (e) {
                    e.classList.add(h),
                    d.add(h),
                    d.remove(k);
                    for (var f, g = e.querySelectorAll(p), i = e.offsetWidth, j = "right" === c ? -i: i, m = g.length, o = 0; m > o; o++) f = g[o],
                    "right" === c ? v(f, -f.offsetLeft) : v(f, i - f.offsetWidth - f.offsetLeft);
                    d.add(k);
                    for (var o = 0; m > o; o++) v(g[o], j);
                    v(b.querySelector(l), j)
                }
            }
        }
    },
    a.swipeoutClose = function(b) {
        if (b) {
            var c = b.classList;
            if (c.contains(h)) {
                var d = b.querySelector(n + o) ? "right": "left",
                e = b.querySelector(a.classSelector(".slider-" + d));
                if (e) {
                    e.classList.remove(h),
                    c.remove(h),
                    c.add(k);
                    var f, g = e.querySelectorAll(p),
                    i = e.offsetWidth,
                    j = g.length;
                    v(b.querySelector(l), 0);
                    for (var m = 0; j > m; m++) f = g[m],
                    "right" === d ? v(f, -f.offsetLeft) : v(f, i - f.offsetWidth - f.offsetLeft)
                }
            }
        }
    },
    ...
    var y = /^(INPUT|TEXTAREA|BUTTON|SELECT)$/;
    b.addEventListener("tap",
    function(b) {
        if (e) {
            var c = !1,
            d = e.classList,
            f = e.parentNode;
            if (f && f.classList.contains(i)) {
                if (d.contains(h)) return;
                var j = f.querySelector("li" + o);
                return j && j.classList.remove(h),
                d.add(h),
            ...
            if (d.contains("mui-collapse") && !e.parentNode.classList.contains("mui-unfold")) {
                if (y.test(b.target.tagName) || b.detail.gesture.preventDefault(), !d.contains(g)) {
...
function(a, b) {
    a.toast = function(c, d, e, f) {
        if (a.os.plus) {
            if (void 0 === c) return;
            "function" == typeof d ? (f = d, d = null, e = "纭畾") : "function" == typeof e && (f = e, e = null),
            a.plusReady(function() {
                plus.nativeUI.toast(c, f, d, e)
            })
        } else b.toast(c)
    }
} (mui, window),
...
function(a, b, c) {
    var d = "mui-popup-backdrop",
    e = "mui-popup-in",
    f = "mui-popup-out",
    g = "mui-popup-input",
    h = "mui-popup-button",
    d = "mui-popup-backdrop",
    i = "mui-active",
    j = [],
    k = function() {
        var b = c.createElement("div");
        ...
        function() {
            this.classList.contains(i) || b.parentNode && b.parentNode.removeChild(b)
        }),
        b
    } (),
    l = function(a) {
        return '<div class="' + g + '"><input type="text" autofocus placeholder="' + (a || "") + '"/></div>'
    },
    m = function(a, b, c) {
        return '<div class="mui-popup-inner"><div class="mui-popup-title">' + b + '</div><div class="mui-popup-text">' + a.replace(/\r\n/g, "<br/>").replace(/\n/g, "<br/>") + "</div>" + (c || "") + "</div>"
    },
    n = function(a) {
        for (var b = a.length,
        c = [], d = 0; b > d; d++) c.push('<span class="' + h + (d === b - 1 ? " mui-popup-button-bold": "") + '">' + a[d] + "</span>");
        return '<div class="mui-popup-buttons">' + c.join("") + "</div>"
    },
    o = function(b, d) {
        var l = c.createElement("div");
        l.className = "mui-popup",
        l.innerHTML = b;
        var m = function() {
            l.parentNode && l.parentNode.removeChild(l),
            l = null
        };
        l.addEventListener(a.EVENT_MOVE, a.preventDefault),
        l.addEventListener("webkitTransitionEnd",
        function(a) {
            l && a.target === l && l.classList.contains(f) && m()
        }),
        l.style.display = "block",
        c.body.appendChild(l),
        l.offsetHeight,
        l.classList.add(e),
        k.classList.contains(i) || (k.style.display = "block", c.body.appendChild(k), k.offsetHeight, k.classList.add(i));
        var n = a.qsa("." + h, l),
        o = l.querySelector("." + g + " input"),
        p = {
            element: l,
            close: function(a, b) {
                if (l) {
                    if (!1 === (d && d({
                        index: a || 0,
                        value: o && o.value || ""
                    }))) return; ! 1 !== b ? (l.classList.remove(e), l.classList.add(f)) : m(),
                    j.pop(),
                    j.length ? j[j.length - 1].show(b) : k.classList.remove(i)
                }
            }
        },
        q = function(a) {
            p.close(n.indexOf(a.target))
        };
        return a(l).on("tap", "." + h, q),
        j.length && j[j.length - 1].hide(),
        j.push({
            close: p.close,
            show: function(a) {
                l.style.display = "block",
    ...
    p = function(b, c, d, e, f) {
        return void 0 !== b ? ("function" == typeof c ? (e = c, f = d, c = null, d = null) : "function" == typeof d && (f = e, e = d, d = null), a.os.plus && "div" !== f ? plus.nativeUI.toast(b, e, c || "鎻愮ず", d || "纭畾") : o(m(b, c || "鎻愮ず") + n([d || "纭畾"]), e)) : void 0
    },
    q = function(b, c, d, e, f) {
        return void 0 !== b ? ("function" == typeof c ? (e = c, f = d, c = null, d = null) : "function" == typeof d && (f = e, e = d, d = null), a.os.plus && "div" !== f ? plus.nativeUI.confirm(b, e, c, d || ["鍙栨秷", "纭"]) : o(m(b, c || "鎻愮ず") + n(d || ["鍙栨秷", "纭"]), e)) : void 0
    },
    r = function(b, c, d, e, f, g) {
        return void 0 !== b ? ("function" == typeof c ? (f = c, g = d, c = null, d = null, e = null) : "function" == typeof d ? (f = d, g = e, d = null, e = null) : "function" == typeof e && (g = f, f = e, e = null), a.os.plus && "div" !== g ? plus.nativeUI.prompt(b, f, d || "鎻愮ず", c, e || ["鍙栨秷", "纭"]) : o(m(b, d || "鎻愮ず", l(c)) + n(e || ["鍙栨秷", "纭"]), f)) : void 0
    },
    s = function() {
        return !! j.length && (j[j.length - 1].close(), !0)
    },
    t = function() {
        for (; j.length;) j[j.length - 1].close()
    };
    a.closePopup = s,
    a.closePopups = t,
    a.toast = p,
...
function(a, b, c) {
    ...
    l = "." + h,
    m = function(a) {
        for (; a && a !== c; a = a.parentNode) if (a.classList && a.classList.contains("mui-input-row")) return a;
        return null
    },
    n = function(a, b) {
        this.element = a,
        ...
        ~this.options.actions.indexOf("slider") ? (this.sliderActionClass = i + " " + j, this.sliderActionSelector = ".mui-tooltip") : (~this.options.actions.indexOf("clear") && (this.clearActionClass = d + " " + e + " " + j, this.clearActionSelector = ".mui-icon-clear"), ~this.options.actions.indexOf("speech") && (this.speechActionClass = d + " " + f, this.speechActionSelector = ".mui-icon-speech"), ~this.options.actions.indexOf("search") && (this.searchActionClass = h, this.searchActionSelector = l), ~this.options.actions.indexOf("password") && (this.passwordActionClass = d + " " + g, this.passwordActionSelector = ".mui-icon-eye")),
        this.init()
    };
    ...
    n.prototype.createAction = function(a, b, e) {
        var f = a.querySelector(e);
        if (!f) {
            var f = c.createElement("span");
            f.className = b,
            b === this.searchActionClass && (f.innerHTML = '<span class="' + d + ' mui-icon-search"></span><span>' + this.element.getAttribute("placeholder") + "</span>", this.element.setAttribute("placeholder", ""), this.element.value.trim() && a.classList.add("mui-active")),
            ...
            if (this.clearActionClass) {
                ...
                function(a, c) { !
                    function(a) {
                        ...
                        function() {
                            f.classList[b.value.trim() ? "remove": "add"](j)
                        })
                    } (c)
                }),
    ...
    n.prototype.setPlaceholder = function(a) {
        if (this.searchActionClass) {
            var b = this.element.parentNode.querySelector(l);
            b && (b.getElementsByTagName("span")[1].innerText = a)
        } else this.element.setAttribute("placeholder", a)
    },
    n.prototype.passwordActionClick = function(a) {
        "text" === this.element.type ? this.element.type = "password": this.element.type = "text",
        this.passwordAction.classList.toggle("mui-active"),
        a.preventDefault()
    },
    n.prototype.clearActionClick = function(b) {
        var c = this;
        c.element.value = "",
        a.focus(c.element),
        c.clearAction.classList.add(j),
        b.preventDefault()
    },
    n.prototype.speechActionClick = function(d) {
        if (b.plus) {
            var e = this,
            f = e.element.value;
            e.element.value = "",
            c.body.classList.add(k),
            ...
            function(a) {
                c.body.classList.remove(k)
            })
        } else toast("only for 5+");
        d.preventDefault()
    },
    ...
    a.fn.transparent = function(a) {
        ...
        return this.each(function() {
            ...
            if (!c) {
                ...
                null !== d && void 0 === a.top && (a.top = d),
                null !== f && void 0 === a.offset && (a.offset = f),
                null !== g && void 0 === a.duration && (a.duration = g),
...
function(a) {
    ...
    e = a.Numbox = a.Class.extend({
        init: function(b, c) {
            ...
            d.options = c,
            d.input = a.qsa(".mui-input-numbox,.mui-numbox-input", d.holder)[0],
            d.plus = a.qsa(".mui-btn-numbox-plus,.mui-numbox-btn-plus", d.holder)[0],
            d.minus = a.qsa(".mui-btn-numbox-minus,.mui-numbox-btn-minus", d.holder)[0],
            d.checkValue(),
            d.initEvent()
        },
        initEvent: function() {
    ...
    a.fn.numbox = function(a) {
        return this.each(function(a, b) {
            if (!b.numbox) if (d) b.numbox = new e(b, d);
            else {
